    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE UPPER(TRIM(cst_gndr))
                ...
                WHEN 'F' THEN 'Female'
                ELSE 'Unknown'
            END AS cst_gndr,           -- Normalize gender details to readable format
            cst_create_date
        FROM(
            SELECT 
                *,
        ...
        WHERE flag_last = 1;        -- Removing duplicate values and keeping the recent ones
        ...
        SELECT
            ...
            END AS sls_order_dt, -- SQL Server cannot convert String value to Date directly. First covert it to VARCCHAR then DATE)
            CASE 
        ...
        SELECT
            ...
            ELSE 'Unknown' -- It will replace all NULL and BLANK values
            END AS gen
